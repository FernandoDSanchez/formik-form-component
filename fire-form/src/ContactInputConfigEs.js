  ...
  inputs: [
    {
      ...
      max: 200,
      helpText:
        "Nos encantaría saber cómo te llamas. ¡No te preocupes, mantendremos esto en la familia Orum! 🤗",
    ...
    },
    {
      ...
      max: 100,
      helpText:
        "Aquí es donde enviaremos el certificado de '¡eres un experto!', ¡así que nada de travesuras! 🏆",
    ...
    },
    {
      ...
      required: true,
      helpText:
        "¿Cuándo empezaste a causar caos por primera vez? No le diremos a nadie, ¡lo prometemos! 🤞",
    ...
    },
    {
      ...
      helpText:
        "¿Quién es esa persona guapa? 🤩 Recuerda, mantenlo por debajo de 5MB y en formato .png o .jpg!",
    ...
    },
    {
      ...
      title: "Sitio web o Redes Sociales",
      required: false,
      helpText:
        "Si tienes un sitio web, o alguna red social que nos quieras compartir ¡déjanos el enlace aquí! Es opcional, pero siempre útil para conocerte mejor. 💻",
    ...
    },
    {
      ...
      type: "textarea",
      placeholder:
        "Describe quién eres y los servicios de bienestar que ofreces",
      title: "Descripción del experto y servicios",
      required: true,
      max: 500,
      helpText:
        "¿Eres un experto en yoga, meditación o nutrición? Cuéntanos más sobre tus habilidades y cómo puedes ayudar a nuestra comunidad. ¡Incluso puedes añadir alguna anécdota divertida! 😄",
      validated:
        "¡Descripción impresionante, tu experiencia y servicios suenan emocionantes! 🌟",
    },
  ],
  button: {
